...
public class Keyboard 
{
    ...
    //-----------------------------------------------------------------
    //  METODO agregado por orientacion de Jimer Orlando Diaz Murillo
    // Este metodo pausa la ejecucion del programa hasta que el usuario
    ...
    public static void pausa() {
        try {
            ...
            error("Error en la pausa, se reanudara la ejecucion del programa");
        }
    }
